...
menu_category = ["Tea & Coffee", "Beverages", "Fast Food", "South Indian", "Starters", "Main Course", "Dessert","Room"]
...
menu_category_dict = {"Tea & Coffee": "1 Tea & Coffee.txt", "Beverages": "2 Beverages.txt",
                      ...
                      "Dessert": "7 Dessert.txt","Room": "8 Room.txt"}
...
def load_menu():
    ...
    menu_file_list = os.listdir("C:/Users/Wiseman/Desktop/Menu")
    for file in menu_file_list:
        f = open("C:/Users/Wiseman/Desktop/Menu/New Text Document.txt", "r")
        category = ""
        while True:
            line = f.readline()
            if (line == ""):
...
def show_button_operation():
    ...
    if category not in menu_category:
        ...
        menu_tabel.delete(*menu_tabel.get_children())
        f = open("C:/Users/Wiseman/Desktop/Menu/" + menu_category_dict[category], "r")
        while True:
            line = f.readline()
            if (line == ""):
                break
...
def bill_button_operation():
    ...
    if ans == "yes":
        ...
        file = open(f"C:/Users/Wiseman/PycharmProjects/Hotelbill/Bill Records{customer_name + customer_contact}.txt", "w")
        file.write(st)
        file.close()
...
root.title("Welcome to Hotel")


style_button = ttk.Style()
style_button.configure("TButton", font=("arial", 10, "bold"),background="red")
title_frame = Frame(root, bd=8, bg="black", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")
title_label = Label(title_frame, text="Hotel",font=("times new roman", 20, "bold"), bg="black", fg="red", pady=5)
title_label.pack()


customer_frame = LabelFrame(root, text="Customer Details", font=("times new roman", 15, "bold"),bd=8, bg="black",fg="red", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")
customer_name_label = Label(customer_frame, text="Name",font=("arial", 15, "bold"), bg="black", fg="red")
...
customer_contact_label = Label(customer_frame, text="Contact",font=("arial", 15, "bold"), bg="black", fg="red")
...
menu_label = Label(menu_frame, text="Menu",font=("times new roman", 20, "bold"), bg="black", fg="red", pady=0)
menu_label.pack(side=TOP, fill="x")
menu_category_frame = Frame(menu_frame, bg="black", pady=10)
menu_category_frame.pack(fill="x")
combo_lable = Label(menu_category_frame, text="Select Type",font=("arial", 12, "bold"), bg="black", fg="red")
...
item_title_label = Label(item_frame, text="Item",font=("times new roman", 20, "bold"), bg="black", fg="red")
item_title_label.pack(side=TOP, fill="x")
item_frame2 = Frame(item_frame, bg="black")
item_frame2.pack(fill=X)
item_name_label = Label(item_frame2, text="Name",font=("arial", 12, "bold"), bg="black", fg="red")
...
item_rate_label = Label(item_frame2, text="Rate",font=("arial", 12, "bold"), bg="black", fg="red")
...
item_quantity_label = Label(item_frame2, text="Quantity",font=("arial", 12, "bold"), bg="black", fg="red")
...
order_title_label = Label(order_frame, text="Your Order",font=("times new roman", 20, "bold"), bg="black", fg="red")
...
total_price_label = Label(order_frame, text="Total Price",font=("arial", 12, "bold"), bg="black", fg="red")
